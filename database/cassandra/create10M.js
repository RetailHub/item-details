...
const createItems = fs.createWriteStream('../itemscassandra.csv');
createItems.write('id | productName| producer | answeredQuestions | numberOfRatings |price | inStock \n', 'utf8');
...
function writeTenMillionUsers(writer, encoding, callback) {
  ...
  function write() {
    ...
    do {
      ...
      //   }
      // }
      const data = `${id} | ${productName} | ${producer} | ${answeredQuestions} | ${numberOfRatings} | ${price} | ${inStock} \n`;
      if (i === 0) {
